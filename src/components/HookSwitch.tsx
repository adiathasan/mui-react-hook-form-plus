...
export interface IFormSwitchProps<T extends FieldValues = FieldValues> extends UseControllerProps<T> {
...
// ====================================================
const HookSwitch = <T extends FieldValues>({ gridProps, ...props }: IFormSwitchProps<T>): React.ReactElement => {
	/**
