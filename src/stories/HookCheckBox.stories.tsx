...
stories.add('@HookCheckBox', () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <h2>This is a MUI <a target='_blank' href="https://mui.com/material-ui/react-checkbox/">CheckBox</a> hooked up with
                react-hook-form</h2>
            <br/>
...
stories.add('Group CheckBox', () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <h3> One downside is that you have to register with a name with
                `registerState()` Fn. </h3>

            <h3>We can even show <span style={{color: 'red'}}>`error`</span> message using custom validation</h3>
